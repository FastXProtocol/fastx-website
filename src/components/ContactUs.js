...
const PrimaryLink = tw(
  Link
)`bg-orange-500 text-gray-100 shadow-lg hocus:bg-orange-400 hocus:text-gray-200`;
...
export default ({
  text = "We're hiring and looking for collaborators!",
  primaryLinkText = "Contact Us",
  primaryLinkUrl = "https://t.me/joinchat/H4r43A75jNkxQPasquwwCg?",
